...
namespace SFA.DAS.Apim.Developer.Data.UnitTests.DatabaseMock
{
    public static class MoqExtensions
    {
        ...
        public static IReturnsResult<IApimDeveloperDataContext> ReturnsDbSet<TEntity>(
            this ISetup<IApimDeveloperDataContext, DbSet<TEntity>> setupResult,
